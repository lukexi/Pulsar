...
- (id) initWithCapacity:(NSUInteger)c	{
	...
	if (self = [super init])	{
        // removed unnecessary check for <0 for NSUInteger
//		if (c < 0)
...
- (void) removeObjectAtIndex:(NSUInteger)i	{
	if ((array!=nil) && ([array count]>0) && (i<[array count])/* && (i>=0)*/)	{ // removed unnecessary i>=0 check for NSUInteger
		@try	{
...
- (id) objectAtIndex:(NSUInteger)i	{
	//if ((array != nil) && (i>=0) && (i<[array count]))	{ // removed unnecessary i>=0 for NSUInteger
    if ((array != nil) && (i<[array count]))	{    
		id			returnMe = nil;
		//@try	{
