...
{
    [SCServer sharedServer];
    [RSSynthDef updateDefsInContext:self.managedObjectContext];
    
    RSGraphEditorViewController *graphEditor = (RSGraphEditorViewController *)self.window.rootViewController;
    graphEditor.managedObjectContext = self.managedObjectContext;
