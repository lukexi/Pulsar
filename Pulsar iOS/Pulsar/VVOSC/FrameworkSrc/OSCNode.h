...
@property (weak, readwrite) id addressSpace;
@property (weak, readwrite) NSString *nodeName;
@property (weak, readonly) NSString *fullName;
@property (weak, readonly) id nodeContents;
@property (weak, readwrite) OSCNode *parentNode;
@property (assign, readwrite) int nodeType;
@property (weak, readonly) OSCMessage *lastReceivedMessage;
@property (weak, readonly) id delegateArray;
