...
/// Creates & returns an auto-released instance of OSCValue representing the beginning of an array
+ (id) createWithArrayOpen;
/// Creates & returns an auto-released instance of OSCValue representing the end of an array
